...
public class alphaRadiation : MonoBehaviour
{
    public int protonNumber = 92; // The starting number of protons (uranium-238)
    public int neutronNumber = 146; // The starting number of neutrons (uranium-238)
